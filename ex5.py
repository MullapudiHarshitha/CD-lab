{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyOU0U1gDV/mnrzEwjUhrOmn",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/MullapudiHarshitha/CD-lab/blob/main/ex5.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "id": "Qu5CorxGtuU3",
        "outputId": "84330845-a2a6-4193-aee9-f1b7862e0677"
      },
      "outputs": [
        {
          "output_type": "stream",
