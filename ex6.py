{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyNCWg+eQ21Zh+2hh1B5Ybd+",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/MullapudiHarshitha/CD-lab/blob/main/ex6.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "id": "gZja556JuPLh",
        "outputId": "980b7bac-d956-4348-c339-2b2dfe42594a"
      },
      "outputs": [
        {
          "output_type": "stream",
